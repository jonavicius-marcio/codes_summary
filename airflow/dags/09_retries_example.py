...
'''
Esssa dag lê dados aleatorios e dá um erro se o num aletório for maior que 0.3. 
O retry_delay=timedelta(seconds=30) re inicia a dag após 30 segundos a ideia é tentar varias vezes até consenguir o acessar
